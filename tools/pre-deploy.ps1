...
Write-Host "  2. Railway openclaw-gateway (+ GEMINI + TOKEN)"
Write-Host "  3. Railway telegram-bot (+ SUPABASE + TELEGRAM)"
Write-Host "  4. Smoke test Telegram (muc 8 trong DEPLOY.md)"
Write-Host ""
